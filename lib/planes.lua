...
local function get_make_model(aircraft)
    ...
    -- GNS 530
    model = "GNS530"
    if first_two_words == "Bell 407"              then return "B407",model end
    ...
    if first_two_words == "Cessna 152"            then return "C152",model end
    ...
    if first_word      == "DR400"                 then return "DR40",model end
    if first_two_words == "DR 400"                then return "DR40",model end
    if first_two_words == "Boeing F/A"            then return "FA18E",model end
